...
case $selected_choice in
    ...
    ;;
    "Create new algorithm") echo "\033[38;2;255;143;252m\033[1mWhat would you like to name it?\033[0m"
        read "name?"
        case "$name" in 
        n|N ) echo "\033[38;2;255;143;252m\033[1m \nExiting!"; return;;
        * ) cd ~/Documents/Projects/Algorithims;
            touch $name.py
            echo "\033[38;2;255;143;252m\033[1m \nCreated $name.py algorithm!\033[0m \033[38;2;255;143;252m";
            code $name.py
        esac
    ;;
    "Start new project directory") echo "\033[38;2;255;143;252m\033[1mWhat would you like to name it?\033[0m"
        read "name?"
        case "$name" in 
        n|N ) echo "\033[38;2;255;143;252m\033[1m \nExiting!"; return;;
