...
choose_from_menu "\033[38;2;255;143;252m\033[1mWhat file format would you like?\033[0m" selected_choice "${selections[@]}"


case $selected_choice in
    "Download as mp3") echo "\033[38;2;255;143;252m\033[1mPlease paste link below\033[0m"
        read "link?"
        case "$link" in 
        n|N ) echo "\033[38;2;255;143;252m\033[1m \nExiting!"; return;;
        * ) cd ~/Downloads;
            echo "\033[38;2;255;143;252m\033[1m \nDownloading!\033[0m \033[38;2;255;143;252m";
            yt-dlp -f bestaudio -x --audio-format mp3 --audio-quality 0 $link;;
        esac;;
    "Download as mp4") echo "\033[38;2;255;143;252m\033[1mPlease paste link below\033[0m"
        read "link?"
        case "$link" in 
        n|N ) echo "\033[38;2;255;143;252m\033[1m \nExiting!"; return;;
        * ) cd ~/Downloads;
